...
<SwitchPrimitives.Root
  className={cn(
    ...
    "data-[state=checked]:bg-pink-400 data-[state=unchecked]:bg-gray-600", // Ensure visible colors for both states
    "data-[state=checked]:border-pink-400 data-[state=unchecked]:border-gray-600", // Add border for visibility
    className
  )}
  {...props}
  ref={ref}
